<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="access.aspx.vb" Inherits="Enbatt.access" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Enbat - Products List </title>
    <meta charset="UTF-8">
                    ...
                    <div class="block-content verticalmenu-content">
                        <ul class="teamo-nav-vertical vertical-menu teamo-clone-mobile-menu">
                            ...
                            <li class="menu-item menu-item-has-children">
                                ...
                                <li class="menu-item">
                                <a title="Inner Plant" href="access.aspx" class="teamo-menu-item-title">مستلزمات العناية والزراعة</a>
                            </li>
                                <li class="menu-item">
                                <a title="Inner Plant" href="blog.aspx" class="teamo-menu-item-title">المدونة</a>
                            </li>
                                ...
                                <div class="products-bottom-content">
                                    <div class="product-thumb">
                                        <div class="thumb-inner">
                                            <a href="#">
                                                <img src="assets/images/Nu.jpg" alt="img">
                                            </a>
                                    ...
                                    <div class="product-info-left">
                                        ...
                                        <ul class="product-attributes">
                                            ...
                                            <li>
                                                <a href="#">مستلزمات العناية والزراعة</a>
                                            </li>
                            ...
                            <div class="product-inner equal-element">
                                ...
                                <div class="products-bottom-content">
                                    <div class="product-thumb">
                                        <div class="thumb-inner">
                                            <a href="#">
                                                <img src="assets/images/Po.png" alt="img">
                                            </a>
                                            <a href="#" class="button quick-wiew-button">لمحة سريعة</a>
                                        </div>
                                    </div>
                                    <div class="product-info-left">
                                        ...
                                        <ul class="product-attributes">
                                            ...
                                            <li>
                                                <a href="#">مسلتزمات العناية والزراعة</a>
