<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="admin.aspx.vb" Inherits="Enbatt.admin" %>
                ...
                <div class="vertical-wapper block-nav-categori">
                    ...
                    <div class="block-content verticalmenu-content">
                        <ul class="teamo-nav-vertical vertical-menu teamo-clone-mobile-menu">
                            <li class="menu-item">
                                <a href="addproducts.aspx" class="teamo-menu-item-title" title="New Arrivals">إضافة منتج</a>
                            </li>
                            <li class="menu-item">
