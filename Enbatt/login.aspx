<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="login.aspx.vb" Inherits="Enbatt.login" %>

<!DOCTYPE html>

<<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>Enbat - Login</title>
	<meta charset="UTF-8">
				...
				<div class="header-nav-wapper main-menu-wapper">
                    ...
                    <div class="block-content verticalmenu-content">
                        <ul class="teamo-nav-vertical vertical-menu teamo-clone-mobile-menu">
                            ...
                            <li class="menu-item">
                                <a title="Inner Plant" href="#" class="teamo-menu-item-title">النباتات الداخلية</a>
                            </li>
                            <li class="menu-item menu-item-has-children">
                                <a title="Out Plant" href="#" class="teamo-menu-item-title">النباتات الخارجية</a>
                                <span class="toggle-submenu"></span>
                                <ul role="menu" class=" submenu">
                                    <li class="menu-item">
                                        <a title="Access" href="#" class="teamo-item-title">مسلتزمات العناية والزراعة</a>
                                    </li>
                                    <li class="menu-item">
                                        <a title="Blog" href="#" class="teamo-item-title">المدونة</a>
									</li>         
								</ul></li></ul>   </div>
                </div>
	</header>
...
&nbsp;</p>
										...
										<form class="register" >
											<p class="form-row form-row-wide">
                                                ...
                                                <asp:TextBox ID="TextBox5" runat="server" pattern="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" title="Must enter correct Email"></asp:TextBox>
&nbsp;</p>
											<p class="form-row form-row-wide">
												<label for="text">Username</label>
...
&nbsp;</p>
											<p class="form-row form-row-wide">
												<label for="text">Password</label>
                                                <asp:TextBox ID="TextBox4" runat="server" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"></asp:TextBox>											</p>
											<p class="form-row">
												<span class="inline">
											...
											<p class="register">
												<asp:Button ID="Button2" runat="server" Text="Register Now" />
&nbsp;</p>
												</form>
									</div>
								</div>
