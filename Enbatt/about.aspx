<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="about.aspx.vb" Inherits="Enbatt.about" %>
                ...
                <div class="vertical-wapper block-nav-categori">
                    ...
                    <div class="block-content verticalmenu-content">
                        <ul class="teamo-nav-vertical vertical-menu teamo-clone-mobile-menu">
                            <li class="menu-item">
                                <a href="listproduct.aspx" class="teamo-menu-item-title" title="New Arrivals">وصل حديثا</a>
                            </li>
                            <li class="menu-item">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="content-area content-about col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="site-main">
                    <h3 class="custom_blog_title">عنا</h3>
                    <div class="page-main-content">
                        
                                        <div class="content-inner">
                                            <h1 class="title">
                                                متجر إنبات مكان واحد لجميع إحتياجات الزراعة الخاصة بك. نباتات داخلية وخارجية ومنتجات زراعية مليئة بالحب والإلهام, نهدف لتقديم تجربة مميزة وفريدة لكم، وإضفاء المزيد من الحيوية والنقاء لأيامكم
    <br />
نحن نقدم مجموعة كبيرة من النباتات جنبًا إلى جنب مع جميع الأدوات والملحقات التي ستحتاجها للبدء. وقد أولينا اهتمامًا خاصًا لتسهيل العثور على كل ما تحتاجه
    <br />
 إذا كنت قد فكرت يومًا في الزراعة ولكن ليس لديك أدنى فكرة من أين تبدأ ، فإن إنبات هو المكان المثالي لك الذي يمكنك أن تجد فيه كل شيء تحتاجه لجميع احتياجاتك في مجال الزراعة
                                ...
                                <div class="teamo-iconbox  layout1">
                                    <div class="iconbox-inner">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="text">
                                                يمكنك الاستفسار عن أي شيء من خلال مراسلتنا على عنوان البريد الألكتروني
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="teamo-iconbox  layout1">
                                    <div class="iconbox-inner">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="text">
                                                نحن موجودون لخدمتكم على مدار الساعة، لاتترد في التواصل معنا
                                            </div>
                                        </div>
                                    </div>
                                </div>
