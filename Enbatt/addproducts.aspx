<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="addproducts.aspx.vb" Inherits="Enbatt.addproducts" %>
...
&nbsp;</p>
											<p class="form-row form-row-wide">
												<label for="text">Productprice</label>
